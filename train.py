...
import utils.losses
from model.LAUNet import LAUNet
...
for epoch in range(start_epoch, OPT['EPOCHS'] + 1):
    ...
    if epoch % Train['VAL_AFTER_EVERY'] == 0:
        ...
        if psnr_val_rgb > best_psnr:
            ...
            torch.save({'epoch': epoch,
                        ...
                        }, os.path.join(model_dir, "LAUNET_checkpoints/LAUnet-HFB/model_bestPSNR.pth"))
        ...
        if ssim_val_rgb > best_ssim:
            ...
            torch.save({'epoch': epoch,
                        'state_dict': model_restored.state_dict(),
                        'optimizer': optimizer.state_dict()
                        }, os.path.join(model_dir, "LAUNET_checkpoints/LAUnet-HFB/model_bestSSIM.pth"))
    ...
    torch.save({'epoch': epoch,
                'state_dict': model_restored.state_dict(),
                'optimizer': optimizer.state_dict()
                }, os.path.join(model_dir, "LAUNET_checkpoints/LAUnet-HFB/model_latest.pth"))
